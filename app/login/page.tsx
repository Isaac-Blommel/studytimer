  ...
  return (
    <div className="min-h-screen gradient-bg flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="glass-effect rounded-2xl p-8 animate-bounce-in">
          ...
          <div className="space-y-6">
            <button
              ...
              disabled={isLoading}
              className="w-full bg-white hover:bg-gray-50 text-gray-900 font-semibold py-4 px-6 rounded-xl border border-gray-200 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
            >
              {isLoading ? (
        ...
        <div className="text-center mt-8 animate-fade-in-up" style={{animationDelay: '0.5s'}}>
          <div className="text-sm text-muted space-y-1">
            <p>New to StudyTimer?</p>
            <p>Just sign in with Google to get started!</p>
          </div>
        </div>
      </div>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-warning/5 rounded-full blur-3xl"></div>
      </div>
    </div>
  )
}
